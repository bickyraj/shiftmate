<?php
    ...
    if(isset($_POST['submit'])){
       ...
       //echo "<pre>";print_r($_POST);die();
        ...
        {
            echo '<script>
                            toastr.error("Sorry no users on the branch.");
                    </script>';
        }
    }
// echo "<pre>";
...
<div class="page-content">
    <div class="container">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="<?php echo URL_VIEW.'messages/inboxMessages'; ?>">Message</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="inbox-content">
                                ...
                                <form class="inbox-compose form-horizontal" id="fileupload" method="POST" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="data[Sender][organization_id]" value="<?php echo $orgId;?>">
                                                        ...
                                                        <?php else:?>
                                                            ...
                                                            <div class="inbox-form-group" id="specificInput" style="display:none;">
                                                                <div class="controls controls-to">
                                                                    <input class="form-control" type="text" placeholder="type username" class="biginput" name="data[Receiver][to]" id="autocomplete">
                                                                </div>
                                                            </div>
                                                            <div class="form-group" id="selectBoardform" style="display:none; margin-top:10px;">
                                                                <div class="col-md-12">
                                                                    <label class="col-md-1 control-label">Branch</label>
                                                                    <div class="col-md-3">
                                                                        <select id="branchSelect" class="form-control input-sm" disabled="disabled" name="data[Sender][branch_id]">
                                                                            <?php foreach ($branchList as $key=>$value):?>
                                                                                <option value="<?php echo $key;?>"><?php echo $value;?></option>
                                                                            <?php endforeach;?>
                                                                        </select>
                                                                    </div>
                                                                    <label class="col-md-1 control-label">Board</label>
                                                                    <div class="col-md-3">
                                                                        <select id="boardSelect" class="form-control input-sm" disabled="disabled" name="data[Sender][board_id]">
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            </div>
        ...
        $("#branchSelect").on('change', function(event)
            {
               ...
               if(data.output.status == 1)
               {
                   ...
                   $.each(data.boardList, function(k,v)
                    {
                        opts += '<option value="'+v.Board.id+'">'+v.Board.title+'</option>';
                    });

                   $("#boardSelect").html("").append(opts);
               }else
               {
                    $("#boardSelect").html("").append("<option>No Boards to select</option>");
               }
            });
