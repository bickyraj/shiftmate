...
//  $url = URL.'Messages/listOfSentMessage/'.$user_id.'/'.$page.'.json';
...
$url = URL.'Senders/sentMsgOrg/'.$orgId.'/'.$page.'.json';
$response = \Httpful\Request::get($url)
->send();
//fal($response);
$messages = $response->body->mySentMessage;
                                                ...
                                                <th class="pagination-control" colspan="3">
                                                    <?php if(isset($pageInfo) && !empty($pageInfo) && $pageInfo->status ==1):?>
                                                        ...
                                                        <?php if($pageInfo->prevPage ==true):?>
                                                            ...
                                                            <a href="<?php echo URL_VIEW;?>messages/sentMessages?page=<?php echo $prev;?>" class="btn btn-sm blue">
                                                        ...
                                                        <?php if($pageInfo->nextPage == true):?>
                                                            ...
                                                            <a href="<?php echo URL_VIEW;?>messages/sentMessages?page=<?php echo $next;?>" class="btn btn-sm blue">
                                                        ...
                                                        {?>
                                                            <tr class="unread" data-messageid="<?php echo $message->Sender->id;?>">
                                                                ...
                                                                <td class="view-message ">
                                                                    ...
                                                                    <i><?php echo substr($message->Sender->content,0,50).'...';?></i>
                                                                </td>
