                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="inbox-content">
                                        ...
                                        <div class="inbox-view-info">
                                            <div class="row">
                                                <div class="col-md-12">
                                                            <?php if(!empty($messageDetail->User->image_dir)):?>
                                                            <img src="<?php echo URL.'webroot/files/user/image/'.$messageDetail->User->image_dir.'/thumb2_'.$messageDetail->User->image;?>" width="20" height="20">
                                                            <?php else:?>
...
<!--                                                             <span class="bold"><?php echo $messageDetail->Organization->title;?></span>
 -->                                                            <span>
                                                            ...
                                                            &#60;<?php echo $messageDetail->User->email;?>&#62; </span>
                                                            to 
