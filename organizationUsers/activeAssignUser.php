<?php
    ...
    $orgUserid= base64_decode($_GET['b3JnVXNlcmlk']);
    $org_id= base64_decode($_GET['b3JnaWQ']);
    $user_id= base64_decode($_GET['dXNlcmlk']);
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#activate').on('click',function(){
            ...
            var org_id = '<?php echo $_GET['orgid']; ?>';
            ...
            $.ajax({                    
                        url:'<?php echo URL."OrganizationUsers/activateAssignUser/"."'+orgUserid+'"."/"."'+org_id+'"."/"."'+user_id+'".".json";?>',
                        type:'post',
                        datatype:'jsonp',
