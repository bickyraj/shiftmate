                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-extended dropdown-inbox" id="header_inbox_bar">
                        <?php if($receivedMessage){ ?>
                            ...
                            <span class="badge badge-default"><?php echo $receivedMessage;?></span>
    						</a>
                        <?php } else { ?>
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true" style="background-color: transparent;">
                                <i class="icon-envelope-open"></i>
                    ...
                    <li class="dropdown dropdown-user dropdown-dark">
                        ...
                        <ul class="dropdown-menu dropdown-menu-default">
                            ...
                            <li>
                                <a href="<?php echo URL_VIEW; ?>calendar/showCalendar">
                    ...
                    <li class="dropdown dropdown-extended dropdown-dark dropdown-notification" id="header_notification_bar">
                        ...
                        <i class="icon-bell"></i>
                        <span class="badge badge-default" id="notificationPopup" style="right:12px;">0</span>
                        </a>
                    </li>  
                    <!-- <li>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#clickMessage").on('click',function(){
            ...
            $.ajax({
                ...
                success:function(response){
                    ...
                    html += '<a href="<?php echo URL_VIEW;?>messages/employeeInbox" target="_blank" class="viewAllMsg">view all</a>';
                    html += '</li>';
                    ...
                    if(response.receivedMessage != 0){ 
                        $.each(response.receivedMessage,function(key,val){
                            ...
                            if(val.Sender.user_id == 0){
                                ...
                                html += '<li class="inbox-content-click" data-messageId="'+val.Receiver.id+'">';
                                ...
                                html += '<li><a>';
                                 //href="<?php echo URL_VIEW; ?>messages/viewEmployeeInbox?msgId='+val.Receiver.id+'"
        ...
        $('.inbox-content-click').live('click', function () {
            //alert("h");
                        ...
                        success:function(response){
                            ...
                            if(response.length != 0){
                                ...
                                $.each(response,function(key,val){
                                    ...
                                    var reviewnotification = val.reviewnotification; 
                                    var username = val.fname + ' ' + val.lname;
                                    var userUrl = '<a href="<?php echo URL_VIEW; ?>organizationUsers/organizationEmployeeDetail?org_id='+orgId+'&user_id='+val.user_id+'">';    
                ...
                if(asABoardManager == '1' || orgId !=0)
                {
                    ...
                    function shiftRequestResponseNotif()
                    {
                        ...
                        else
                        {
                            ...
                            var url = '<?php echo URL."ShiftUsers/shiftResponseNotifications/"."'+orgId+'"."/"."'+boardManagerList+'".".json";?>';
                                ...
                                $.ajax(
                                    {
                                        ...
                                        success:function(response)
                                        {
                                            ...
                                            if(response.output ===1)
                                            {
                                                        ...
                                                        data+='<li>'+
                                                                    '<div class="col1">'+
                                                                        '<div class="cont">'+
                                                                            ...
                                                                            '<div class="cont-col2">'+
                                                                                '<div class="desc">'+
                                                                                v.User.fname+' '+v.User.lname+' '+res+' your shift request.'
                                                                                '</div>'+
                                                                            '</div>'+
                                                                        '</div>'+
                                                                    '</div>'+
                                                ...
                                                $(".notificationListDiv").prepend(data);
                                            }
                                        }
                                    });
                            },1000);
