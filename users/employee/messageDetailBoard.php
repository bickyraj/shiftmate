...
<?php
	...
	$messageDetail = getMessageDetailBoard($message_id);
	//echo "<pre>";
...
<div class="viewMsgContainer">
    ...
    <?php $dateTime = explode(" ",$messageDetail->Boardmessage->date_time);$date = ($dateTime['0']);$time = ($dateTime['1']);?>
    ...
    <div class="msg"><?php echo $messageDetail->Boardmessage->content;?></div>
</div>
...
<a class="backBtn" href="<?php echo URL_VIEW."users/employee/boardMessage";?>" style="color:#000">Back</a> 

<div style="display:none;">
	<div id="reply">
    <form method="post" action="">
    <input type="hidden" name="data[Boardmessage][user_id]" value="<?php echo $user_id;?>">
    <input type="hidden" name="data[Boardmessage][parent_id]" value="<?php echo $messageDetail->Boardmessage->id;?>">
    <input type="hidden" name="data[Boardmessage][board_id]" value="<?php echo $messageDetail->Boardmessage->board_id;?>">
		<table>
            <tr>
