...
$userListSentMessage = getUserListSentMessage($user_id);
//print_r($userListSentMessage);
	// User List
	//$users = getUserList();
    ...
    ->send();	
		...
		if($response->body->output == 1){
			...
			{
				window.location.href = '<?php echo $sentMessage_link;?>';
				});
			</script>
            <?php
		}}
		...
		//print_r($response);
		if(isset($_SESSION['output']) && !empty($_SESSION['output']) && $_SESSION['output'] == 1 && empty($response)){
			//echo "asdfdasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasas";
			$_SESSION['output'] = '';
			//die('hehe');
			?>
...
<div id="delete_success">Message Deleted Successfully !!</div>
<!-- End of Success Div -->
...
<div class="RightPart">
    <div class="orgMsgContainer">
        <div class="orgMessageListDiv"><div class="msgSelectAll"><input type="checkbox" name="data[Message][groupCheck]" value="1" id="groupCheck">Select All</div><div class="generalTotal">Total - <?php echo count($userListSentMessage->sentMessage);?></div></div>
            ...
            <div class="msgContainer">
                ...
                <div class="organizationMessageDiv">
                    ...
                    <table class="msgListTable generalMsgTable">
                    	<?php foreach($userListSentMessage->sentMessage as $messages):?>
