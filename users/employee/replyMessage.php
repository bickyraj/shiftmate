...
$url = URL."Users/userDetail/".$to.".json";
$response = \Httpful\Request::get($url)->send();

if(isset($response->body->message->User->email)){
    $email = $response->body->message->User->email;
}else{
    $email = "";
}
...
<div class="page-content">
    <div class="container">
                        ...
                        <div class="row inbox">
                            ...
                            <div class="col-md-10">
                                <div class="inbox-header">
                                    <h1 class="pull-left">Reply to</h1>
                                </div>
                                    ...
                                    <form class="inbox-compose form-horizontal" id="fileupload" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="inbox-form-group">
                                                ...
                                                <div class="inbox-form-group mail-to">
                                                    ...
                                                    <div class="controls controls-to">
                                                        ...
                                                        <!-- <input id="msgId" type="hidden" name="data[Message][to]" value="<?php echo $to;?>"> -->
                                                        <input class="form-control" type="text" placeholder="type username" value="<?php echo $email;?>" name="data[Message][to]" class="biginput" id="autocomplete" required>
                                        ...
                                        <?php else:?>
                                            ...
                                            <div class="inbox-form-group" id="specificInput" style="display:none;">
                                                <div class="controls controls-to">
                                                    <input class="form-control" type="text" placeholder="type username" class="biginput" id="autocomplete" value="<?=$email;?>"></div>
                                            </div>
                                        <?php endif;?>
                                        ...
                                        <script id="template-upload" type="text/x-tmpl">
                                            ...
                                            <tr class="template-upload fade">
                                                ...
                                                <td class="cancel" width="10%" align="right">{% if (!i) { %}
                                                    <button class="btn btn-sm red cancel"> <i class="fa fa-ban"></i>
                                                        <span>Cancel</span>
                                                    </button>
                                                    {% } %}</td>
                                                </tr>
                                        ...
                                        <script id="template-download" type="text/x-tmpl">
                                            ...
                                            <tr class="template-download fade">
                                                ...
                                                <td class="delete" width="10%" align="right">
                                                    <button class="btn default btn-sm" data-type="{%=file.delete_type%}" data-url="{%=file.delete_url%}"{% if (file.delete_with_credentials) { %} data-xhr-fields='{"withCredentials":true}'{% } %}> <i class="fa fa-times"></i>
                                                    </button>
                                                </td>
                                            </tr>
                                            {% } %}
        ...
        <script type="text/javascript">
            ...
            $(function()
            {
                $("#radio7").on('click', function(ev)
                {
                    $("#specificInput").show();

                });

                $("#radio6").on('click', function(ev)
                {
                    $("#msgId").attr('value', '0');
                    $("#specificInput").hide();
                });
