...
<div class="page-content">
    <div class="container">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="<?=URL_VIEW."organizationfunctions/listHoliday";?>">Events/Holidays</a>
            </li>
        </ul>
                ...
                <div class="portlet light ">
            		<div class="portlet-title">
            			<div class="caption">
                            ...
                            <span class="caption-subject font-green-sharp bold uppercase">Events/Holidays</span>
                        </div>
            		</div>
            				...
            				<div class="col-md-3 col-sm-12">
                                <div id='external-events'>
                                    ...
                                    <div class="row">
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                <input type="text" style="height: 35px;" class="form-control newevnt" placeholder="new event/holiday"/>
                                            </div>
                                        </div>
                                ...
                                <div>    
                                    <h3>Labels</h3>
                                    <hr>
                                    <ul style="padding:0px;"><li style="display:inline-block;height: 20px;width: 20px;background-color:#EF5151"></li><li style="display:inline-block;"><strong>&nbsp;&nbsp;Organisation Holiday</strong></li></ul>
                                    <ul style="padding:0px;"><li style="display:inline-block;height: 20px;width: 20px;background-color:#63C178"></li><li style="display:inline-block;"><strong>&nbsp;&nbsp;Events</strong></li></ul>
            ...
            success:function(data){
               ...
               $('#calendar12').fullCalendar({
                    ...
                    eventRender: function (event, element, view) {  
                        var e = element;
                        e.addClass('organizationHolidayBox')
        			...
        			drop: function(date, allDay) { 
                            ...
                            if($('#holodaytype').val() == 0)
                            {
                                copiedEventObject.backgroundColor = "#EF5151";
                            }else
                            {
                                copiedEventObject.backgroundColor = "#63C178";
                            }
                    
                        var a = new Date();

                        var dateD = date._d.getDate();
                        var aD = a.getDate();

                        if(dateD == aD)
                        {
                            alert("You cannot create event/holiday on a current date.");
                        }else if(date < a){
                                ...
                                $.ajax({
                                    ...
                                    success:function(data){
                                        if(data.output.status == 1){
                                           ...
                                           var objData =  $.map(data.output.data, function(val, key) { return val; });
                                            // console.log(objData[0]);

                                            copiedEventObject.branchId = objData[0].branch_id;
                                            copiedEventObject.stat = objData[0].status;
                                            copiedEventObject.fxnId = objData[0].id;
                                ...
                                $.ajax({
                                    ...
                                    success:function(data1){
                                        ...
                                        if(data1.fxn != "error"){
                                            ...
                                            var objData =  $.map(data1.fxn, function(val, key) { return val; });
                                            // console.log(objData);
                    ...
                    eventDrop: function(event, delta, revertFunc ) {
                        ...
                        var dateD = event.start._d.getDate();
                        var aD = a.getDate();
                    ...
                    eventClick: function(calEvent, jsEvent, view) {
                        ...
                        if(typeof calEvent.stat !== "undefined")
                        {

                            if(calEvent.stat == 0)
                            {
                                var Typeoptn='<option value="0" selected>Organisation Holiday</option><option value="1">Event</option>';
                            }else if(calEvent.stat == 1)
                            {
                                var Typeoptn='<option value="0">Organisation Holiday</option><option value="1" selected>Event</option>';
                            }
                                bootbox.dialog({
                                    title: "Edit Holiday",
                                                ...
                                                $.ajax({
                                                   ...
                                                   success:function(data){
                                                        if(data.called == 1){
                                                            ...
                                                            $('#calendar12').fullCalendar('removeEvents',calEvent._id);
                                                            // $('#calendar12').fullCalendar( 'destroy' );
                                                            // loadCalender();
                                                        }
                                                   }
