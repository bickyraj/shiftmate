...
<div class="page-head">
    <div class="container">
        <div class="page-title">
            <h1>Organization <small> calendar</small></h1>
        </div>  
    </div>
</div>
<div class="page-content">
    <div class="container-fluid">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="<?=URL_VIEW."organizations/organizationProfile";?>">Organization Management</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption caption-md">
                                ...
                                <span class="caption-subject theme-font bold uppercase">Assign Shift</span>
                        ...
                        <div class="portlet-body">
                                ...
                                <?php }} ?>
                                <hr /><h4>Labels&nbsp;&nbsp;<small><small>per Shift</small></small></h4>
                                <?php 
               ...
               $.ajax({
                    ...
                    success:function(users) {
                        ...
                        $.each(users.orgUsr,function(k,v){
                            if(loadTime == 1){
                                dataResource.push({title : v.User.fname + " " + v.User.lname,id : v.User.id});
                            }else{
                           ...
                           bootbox.dialog({
                               ...
                               buttons: {
                                   success: {
                                       ...
                                       className: "btn-info",
                                       callback: function() {
                                           saveOpenShiftUser(<?=$orgId;?>,$('#boardDateClick').val(),$('#schedularTaskDateClick').val(),date.format("YYYY-MM-DD"),$('#empNoCal').val());
                                       }
                                   }
           ...
           eventClick: function(calEvent, jsEvent, view) {
            ...
            eventRender: function(event, element, view) {
                ...
                if(event.shift_status==3){
                    $(element).find('span:first').append('<br/><img width="18px" height="18px" src="<?php echo URL_VIEW."images/confirm.png";?>" />');
                } else if(event.shift_status==1){
                    $(element).find('span:first').append('<br/><img width="18px" height="18px" src="<?php echo URL_VIEW."images/waiting.png";?>" />');

                } else if(event.shift_status==2){
                    $(element).find('span:first').append('<br/><img width="18px" height="18px" src="<?php echo URL_VIEW."images/pendingimg.png";?>" />');
                } else if(event.shift_status==0){
                    $(element).find('span:first').append('<br/><img width="18px" height="18px" src="<?php echo URL_VIEW."images/open.png";?>" />');
                }
            },
