...
if (isset($_POST['submit'])){  
        ...
        $_POST['data']['User']['country_id'] = 2;
        $_POST['data']['User']['suburb'] = $_POST['employeeSuburb'];
        $_POST['data']['User']['city_id'] = 0;
       ...
       {
            $_SESSION['success']= " Registration successful. Please check your e-mail to activate";
            echo("<script>
    ...
    <form class="employeeReg" action="" id="OrganizationAddForm" enctype="multipart/form-data" method="post" accept-charset="utf-8">
        ...
        <div class="form-group">
            ...
            <div class="input-icon">
                ...
                <input name="employeeFname" class="form-control placeholder-no-fix" maxlength="200" type="text" id="employeefname" placeholder="First Name" required="required"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="input-icon">
                <i class="fa fa-font"></i><!-- 
                <input class="form-control placeholder-no-fix" type="text" placeholder="Full Name" name="fullname"/> -->
                <input name="employeeLname" class="form-control placeholder-no-fix" maxlength="200" type="text" id="employeelname" placeholder="Last Name" required="required"/>
            </div>
        </div>
        ...
        <div class="form-group avatar-view input-icon" title="Upload Image">
                    <label for="image">Image</label>&nbsp;
                    <a class="btn btn-success">Choose Image</a>
                    <input type="hidden" id="namePicInput" name="avatar"/>
                </div>

    <div id="chooseImage" class="avatar-modal" style="display:none;">
        ...
        <div class="form-group">
            ...
            <div class="input-icon">
                ...
                <input class="form-control placeholder-no-fix" type="number" id="OrganizationPhone" placeholder="Contact Number" name="employeePhone"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="input-icon">
                ...
                <div class="input-group input-medium date" id="dobDatePicker" data-date-format="dd-mm-yyyy">
                    <input type="text" name="employeeDob" class="form-control" placeholder="Date Of Birth" readonly="" />
                    <span class="input-group-btn">
                        <button class="btn default form-control" type="button" style="width: 40px;"><i class="fa fa-calendar"></i></button>
                    </span>
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="input-icon">
                ...
                <input class="form-control placeholder-no-fix" type="text" onFocus="geolocate()" id="autocomplete" placeholder="Post code" name="employeeAddress"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="input-icon">
                ...
                <input class="form-control placeholder-no-fix" type="hidden" id="postal_code" placeholder="Post code" name="EmployeeZipCode"/>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="input-icon">
                ...
                <i class="fa fa-map-marker"></i> -->
                    <input class="form-control placeholder-no-fix" type="hidden" id="route" name="employeeSuburb" placeholder="Enter your Sub Urb" />
            </div>
        </div>
         <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">State</label>
            <div class="input-icon">
                <input class="form-control placeholder-no-fix" type="hidden" id="administrative_area_level_1" placeholder="State" name="employeeState"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="input-icon">
                ...
                <input class="form-control placeholder-no-fix" type="password" autocomplete="off" id="register_password" placeholder="Password" minlength="6" name="password"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="controls">
                <div class="input-icon">
                    ...
                    <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Re-type Your Password" minlength="6" id="rpassword" name="rpassword"/>
        ...
        <div class="form-actions">
            ...
            <!-- <input  type="submit" name="submit" value="Sign Up" class="btn blue pull-right"/> -->
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $("#employeefname").blur(function(){
            var Fname = $(this).val();
           
            document.getElementById('employeefname').value =  toTitleCase(Fname);
        });
        $("#employeelname").blur(function(){
            var Lname = $(this).val();
           
            document.getElementById('employeelname').value =  toTitleCase(Lname);
        });
