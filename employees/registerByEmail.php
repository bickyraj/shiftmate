...
<?php
    ...
    $user_id= base64_decode($_GET['dXNlcklk']);
...
//Get List of Cities
$url = URL . "Users/userInfo/".$user_id.".json";
$user = \Httpful\Request::get($url)->send();
$userDetails = $user->body->output;
// echo "<pre>";
// print_r($userDetails);
// die();
...
if (isset($_POST['submit'])){ 
        ...
        // print_r($_POST['data']);
        // die();
        $url = URL . "Users/employeeRegisterByEmailUpdate/".$orgUserId."/".$user_id.".json";
    ...
    <form class="employeeReg" action="" id="OrganizationAddForm" enctype="multipart/form-data" method="post" accept-charset="utf-8">
        ...
        <div class="form-group">
            ...
            <div class="input-icon">
                ...
                <input class="form-control placeholder-no-fix" type="email" maxlength="255" placeholder="Email" value="<?php echo $userDetails->User->email; ?>" name="email" id="orgEmail" readonly/>
            </div>
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            ...
            <div class="input-icon">
                ...
                <input class="form-control placeholder-no-fix" type="text" id="employeeState" placeholder="State" name="employeeState"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="input-icon">
                <i class="fa fa-location-arrow"></i>
                <input class="form-control placeholder-no-fix" type="text" type="text" id="employeeXipCode" placeholder="Zip COde" name="EmployeeZipCode"/>
            </div>
        </div>
