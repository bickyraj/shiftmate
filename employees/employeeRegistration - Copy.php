...
<div id="crop-avatar">
    ...
    <form class="employeeReg" action="" id="OrganizationAddForm" enctype="multipart/form-data" method="post" accept-charset="utf-8">
        ...
        <div class="form-group">
            ...
            <div class="input-icon">
                ...
                <input name="employeeAddress" maxlength="255" type="text" id="UserAddress" required="required" class="form-control placeholder-no-fix" placeholder="Address" />
            </div>
        </div>
    ...
    <div id="chooseImage" class="avatar-modal" style="display:none;">
        ...
        <div class="form-group">
            ...
            <div class="input-icon">
                <i class="fa fa-location-arrow"></i>
                <input class="form-control placeholder-no-fix" type="tel" id="OrganizationPhone" placeholder="Contact Number" name="employeePhone"/>
            </div>
        </div>
...
<script>
$('#avatar-modal').on('hide.bs.modal', function (e) {
    $('.modal-backdrop').remove();
    if($('.avatar-preview img').attr('src') == "undefined"){
        $('#chooseImage').hide();
    }else{
        $('#chooseImage').show();
    }
