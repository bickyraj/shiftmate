<?php
    ...
    $random_activation= base64_decode($_GET['cmFuZG9tX2FjdGl2YXRpb24']);
...
<div class="container">
    <div class="row">
        <div class="col-md-12 coming-soon-header" style="text-align:center;">
            <img src="<?php echo URL_VIEW;?>admin/layout/img/logo.png" alt="logo">
        </div>

    </div>
    <div class="row">
        <div class="col-md-6 coming-soon-content" style="text-align:center;">
            <h3>Hi <?php echo $userDetail->User->fname.' '.$userDetail->User->lname; ?>,your registration is completed!</h3>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#activate').on('click',function(){
            ...
            var activation_number = '<?php echo $random_activation; ?>';
            var org_user_id = '<?php echo $orgUserId; ?>';
             
            $.ajax({
                    
                        url:'<?php echo URL."Users/activateNewUserAssignByOrg/"."'+user_id+'"."/"."'+role_id+'"."/"."'+activation_number+'"."/"."'+org_user_id+'".".json";?>',
                        type:'post',
                        datatype:'jsonp',
                       success:function(response)
                                {
