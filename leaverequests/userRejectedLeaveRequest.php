...
<div class="page-head">
    <div class="container">
        <div class="page-title">
		    <h1>Leave Requests <small>Rejected.</small></h1>
	    </div>  
    </div>
</div>
         <div class="page-content">
            <div class="container">
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
            			<a href="#">Rejected Leave Requests</a>
            		</li>
                </ul>
                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption caption-md">
                            ...
                            <span class="caption-subject theme-font bold uppercase">User Rejected Leave Requests</span>
                ...
                $status=2; //0-requested 1-accepted 2-rejected
