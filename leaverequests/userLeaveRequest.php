...
<div class="page-head">
    <div class="container">
        <div class="page-title">
			<h1>Leave Requests <small>Pending.</small></h1>
		</div>  
    </div>
</div>
        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption caption-md">
                    ...
                    <span class="caption-subject theme-font bold uppercase">User Pending Leave Requests</span>
            ...
            <div class="portlet-body">
                <div class="row">
                    ...
                    $status=0; //0-requested 1-accepted 2-rejected
                    $url = URL."Leaverequests/distinctLeaveUsers/".$orgId."/".$startlimit."/".$status.".json";
                    $leaveDistinct = \Httpful\Request::get($url)->send();
                    $count=0;
                    if(isset($leaveDistinct->body->leaveDistinct->datas) && !empty($leaveDistinct->body->leaveDistinct->datas)){
                    ...
                    <div class="thumbnail col-sm-3 col-md-3" style="margin-left: 40px;">
                    	...
                    	<!-- <img class="img-responsive" src="<?php echo URL."webroot/files/user/image/".$data->User->image_dir."/".$data->User->image?>" alt="pro pic" style="width: 250px; height: 150px; display: block;"> -->
                    	<div class="caption">
                            <div class="row">
                                <div class="col-md-8 col-sm-8">
                                    ...
                                    <a href="<?php echo URL_VIEW."organizationUsers/organizationEmployeeDetail?org_id=".$orgId."&user_id=".$data->User->id;?>">

                                    <?php echo ucwords($data->User->fname." ".$data->User->lname); ?></a></strong></p>
