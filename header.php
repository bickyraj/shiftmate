...
<!-- END THEME STYLES -->
<link rel="shortcut icon" type="image/x-icon" href="<?php echo URL_VIEW; ?>favicon.ico">
            ...
            <div class="top-menu">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-user dropdown-dark">
                        ...
                        ?>
                        <?php echo $orgDetails->Organization->title; ?></span>
                        ...
                        <ul class="dropdown-menu dropdown-menu-default">
                            ...
                            <li>
                                <?php if ($_SESSION['user_type'] == 'organization'):?>
                                    <a href="<?php echo URL_VIEW; ?>calendar/orgCalendar">
                                <?php else: ?>
