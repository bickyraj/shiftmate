...
$noticeboard_link = URL_VIEW."noticeboards/list_noticeboards?org_id=".$orgId;

$organization_profile_link = URL_VIEW."organizations/organizationProfile?org_id=".$orgId;
?>
...
<!-- navigation -->
            ...
            <div class="navigation">
             ...
             <div class="navigation">
                <ul>
                    <li>
                        <a href="<?php echo $noticeboard_link;?>" class="">
                    <img src="<?php echo URL_IMAGE;?>whiteHome.png" />
                Notice Board</a>
